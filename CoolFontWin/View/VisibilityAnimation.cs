...
namespace CFW.View
{
    ...
    public sealed class VisibilityAnimation
    {
        ...
        private static object CoerceVisibility(DependencyObject dependencyObject, object baseValue)
        {
            ...
            switch (GetAnimationType(dependencyObject))
            {
                case AnimationType.Fade:
                    property = UIElement.OpacityProperty;
                    doubleAnimation = GetFadeAnimation(visibility);
                    break;

                case AnimationType.Expand:
                    property = FrameworkElement.HeightProperty;
                    doubleAnimation = GetExpandAnimation(visibility, frameworkElement.Height, GetTargetHeight(dependencyObject));
                    break;
        ...
        private static DoubleAnimation GetExpandAnimation(Visibility visibility, double? currentHeight, double? targetHeight)
        {
            ...
            {
                // Fade out
                doubleAnimation.From = currentHeight;
